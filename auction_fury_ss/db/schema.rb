...
ActiveRecord::Schema.define(version: 20160825171347) do

  create_table "add_approved_column_to_assignments", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "items", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["auction_id"], name: "index_items_on_auction_id", using: :btree
